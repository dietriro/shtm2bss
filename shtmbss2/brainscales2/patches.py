...
def pynn_simulator_state_configure_recorders_populations(self):
    ...
    if execute_calib:
        ...
        for synapse_driver_block in self.grenade_chip_config.synapse_driver_blocks:
            synapse_driver_block.padi_bus.dacen_pulse_extension.fill(synapse_driver_block.padi_bus.DacenPulseExtension(0))
...
os.environ["PATH"] = os.path.dirname(os.path.realpath(__file__)).replace(" ", "\\ ") + "/_patches/bin:" + os.environ["PATH"]